...
namespace YellowBlossom.Infrastructure.Data.Migrations
{
    ...
    [Migration("20250405130602_ProjectMigration")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("YellowBlossom.Domain.Models.PMIS.Product", b =>
                {
            ...
            modelBuilder.Entity("YellowBlossom.Domain.Models.PMIS.Project", b =>
                {
            ...
            modelBuilder.Entity("YellowBlossom.Domain.Models.PMIS.ProjectStatus", b =>
                {
                    b.Property<Guid>("ProjectStatusId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("YellowBlossom.Domain.Models.PMIS.ProjectType", b =>
                {
                    b.Property<Guid>("ProjectTypeId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("YellowBlossom.Domain.Models.PMIS.Project", b =>
                {
                    b.HasOne("YellowBlossom.Domain.Models.PMIS.Product", "Product")
                        .WithMany("Projects")
                        .HasForeignKey("ProductId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("YellowBlossom.Domain.Models.PMIS.ProjectStatus", "ProjectStatus")
                        .WithMany("Projects")
                        .HasForeignKey("ProjectStatusId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("YellowBlossom.Domain.Models.PMIS.ProjectType", "ProjectType")
                        .WithMany("Projects")
